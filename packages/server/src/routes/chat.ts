...
import { Mode, MessageStatus } from "@mushroomcode/database/enums";
import { type ChatStreamEvent } from "@mushroomcode/shared";
...
function buildConversationHistory(
  messages: { role: "USER" | "ASSISTANT" | "ERROR"; content: string; message: MessageStatus }[],
) {
